...
export default function Register({ onLoginSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    onLoginSuccess({ name: fullName, role });
    navigate('/dashboard');
  };
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.875rem', color: isLightTheme ? '#64665e' : '#94a3b8', margin: '0 0 28px 0' }}>
            ...
            <Link to="/login" style={{ color: isLightTheme ? '#059669' : '#818cf8', fontWeight: 600, textDecoration: 'none' }}>
              Log in
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', fontSize: '0.8rem' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', color: isLightTheme ? '#64665e' : '#cbd5e1' }}>
                <input
                  type="checkbox"
                  checked={agreeTerms}
                ...
                />
                I agree to the <span style={{ color: isLightTheme ? '#059669' : '#818cf8', textDecoration: 'underline' }}>Terms & Conditions</span>
              </label>
            </div>
